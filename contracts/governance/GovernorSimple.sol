...
/**
 * @dev Modified lightly from OpenZeppelin's Governance contract to support three option voting via callback.
...
abstract contract GovernorSimple is Context, ERC165, EIP712, IGovernor, IERC721Receiver, IERC1155Receiver {
    ...
    function propose(
        ...
        ProposalCore storage proposal = _proposals[proposalId];
        require(proposal.voteStart.isUnset(), "GovernorSimple: proposal already exists");
    ...
    function _execute(
        ...
        string memory errorMessage = "GovernorSimple: call reverted without message";
    ...
    function _cancel(
        ...
        require(
            ...
            "GovernorSimple: proposal not active"
        );
